...
export function ServiceCard({ service }: { service: Service }) {
  return (
    <Link
      ...
      className="card-lift group relative flex flex-col overflow-hidden rounded-[1.25rem] border border-line bg-panel p-6 focus-visible:outline-2 focus-visible:outline-pj-secondary light:shadow-[0_6px_24px_-14px_rgba(25,0,58,0.22)]"
    >
