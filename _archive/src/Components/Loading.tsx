...
export const Loading = ({color = 'text-gray-200'}: { color?: string }): ReactElement => {
		return (
				<div
						className="grid w-full justify-end p-6 py-2 overflow-x-scroll rounded-lg lg:overflow-visible">
