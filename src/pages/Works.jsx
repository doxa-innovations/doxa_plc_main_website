...
export const Works = ()=>{
    ...
    <div className="h-full relative">
        ...
        <div className={`${showing == null && 'flex' || 'hidden'} flex-col items-center mt-4 w-full absolute top-1/2 transform -translate-y-1/2`}>
    ...
    return (
        <div className={`${showing != null && 'block' || 'hidden'} w-full h-[80%] bg-pj-dark bottom-0 absolute z-30 px-10 transition ease-in duration-500`}>
            <div className="relative">
                <h3 className="text-4xl font-bold text-pj-primary py-5">ዜና ክርስቶስ || Christ Chronicles</h3>
                <button
                ...
                <div className="grid place-items-center grid-flow-col grid-cols-4 py-10">
                    <div className="col-span-2 text-pj-white px-6">
                        <div className="text-3xl text-pj-secondary font-semibold py-3 flex items-center justify-center">
                            A Podcast Website
                        ...
                        <ul className="flex gap-2 my-5 px-2 items-center">
                            <h4 className="pr-2">Technologies Used:</h4>
                            <li className="px-4 py-2 rounded-full text-sm bg-pj-secondary text-pj-accent">Laravel</li>
                            <li className="px-4 py-2 rounded-full text-sm bg-pj-secondary text-pj-accent">Tailwind</li>
                        </ul>
                    </div>
                    <img className="col-span-2 px-6 border-l-2 border-pj-secondary" src={zenaKristosPage} alt="" />
                </div>
            </div>
        </div>
    )
...
const YenetaMaster = ({showing, setShowing})=>{
    ...
    return (
        <div className={`${showing != null && 'block' || 'hidden'} w-full h-[80%] bg-pj-dark bottom-0 absolute z-30 px-10 transition ease-in duration-500`}>
            <div className="relative">
                <h3 className="text-4xl font-bold text-pj-primary py-5">Yeneta Master Schools</h3>
                <button
                    onClick={()=>{setShowing(null);}} 
                    className="text-2xl text-pj-secondary absolute top-0 right-0 p-5 hover:text-pj-primary hover:-scale-105"
                >
                ...
                <div className="grid place-items-center grid-flow-col grid-cols-4 py-10">
                    <div className="col-span-2 text-pj-white px-6">
                        ...
                        <ul className="flex gap-2 my-5 px-2 items-center">
                            <h4 className="pr-2">Technologies Used:</h4>
                            <li className="px-4 py-2 rounded-full text-sm bg-pj-secondary text-pj-accent">Blade</li>
                            <li className="px-4 py-2 rounded-full text-sm bg-pj-secondary text-pj-accent">Bootstrap</li>
                            <li className="px-4 py-2 rounded-full text-sm bg-pj-secondary text-pj-accent">Laravel</li>
                            <li className="px-4 py-2 rounded-full text-sm bg-pj-secondary text-pj-accent">Inispinia Template</li>
                        </ul>
                    </div>
                    <img className="col-span-2 px-6 border-l-2 border-pj-secondary" src={ymPage} alt="" />
                </div>
            </div>
        </div>
    )
...
const Maor = ({showing, setShowing})=>{
    ...
    return (
        <div className={`${showing != null && 'block' || 'hidden'} w-full h-[80%] bg-pj-dark bottom-0 absolute z-30 px-10 transition ease-in duration-500`}>
            <div className="relative">
                <h3 className="text-4xl font-bold text-pj-primary py-5">Maor Lutheran Theological Seminary</h3>
                <button
                    onClick={()=>{setShowing(null);}} 
                    className="text-2xl text-pj-secondary absolute top-0 right-0 p-5 hover:text-pj-primary hover:-scale-105"
                >
                ...
                <div className="grid place-items-center grid-flow-col grid-cols-4 py-10">
                    <div className="col-span-2 text-pj-white px-6">
                        ...
                        <ul className="flex gap-2 my-5 px-2 items-center">
                            <h4 className="pr-2">Technologies Used:</h4>
                            <li className="px-4 py-2 rounded-full text-sm bg-pj-secondary text-pj-accent">React</li>
                            <li className="px-4 py-2 rounded-full text-sm bg-pj-secondary text-pj-accent">SCSS</li>
                        </ul>
                    </div>
                    <img className="col-span-2 px-6 border-l-2 border-pj-secondary" src={maor} alt="" />
                </div>
            </div>
        </div>
    )
...
const Kofficho = ({showing, setShowing})=>{
    ...
    return (
        <div className={`${showing != null && 'block' || 'hidden'} w-full h-[80%] bg-pj-dark bottom-0 absolute z-30 px-10 transition ease-in duration-500`}>
            <div className="relative">
                <h3 className="text-4xl font-bold text-pj-primary py-5">Kofficho Coffee</h3>
                <button
                    onClick={()=>{setShowing(null);}} 
                    className="text-2xl text-pj-secondary absolute top-0 right-0 p-5 hover:text-pj-primary hover:-scale-105"
                >
...
const Zoe = ({showing, setShowing})=>{
    ...
    return (
        <div className={`${showing != null && 'block' || 'hidden'} w-full h-[80%] bg-pj-dark bottom-0 absolute z-30 px-10 transition ease-in duration-500`}>
            <div className="relative">
                <h3 className="text-4xl font-bold text-pj-primary py-5">Zoe Plant Delivary</h3>
                <button
                    onClick={()=>{setShowing(null);}} 
                    className="text-2xl text-pj-secondary absolute top-0 right-0 p-5 hover:text-pj-primary hover:-scale-105"
                >
                ...
                <div className="grid place-items-center grid-flow-col grid-cols-4 py-10">
                    ...
                    <img className="col-span-2 px-6 border-l-2 border-pj-secondary" src={zoePage} alt="" />
                </div>
            </div>
        </div>
    )
...
const Emebet = ({showing, setShowing})=>{
    ...
    return (
        <div className={`${showing != null && 'block' || 'hidden'} w-full h-[80%] bg-pj-dark bottom-0 absolute z-30 px-10 transition ease-in duration-500`}>
            <div className="relative">
                <h3 className="text-4xl font-bold text-pj-primary py-5">Dr Emebet Dental Clinic</h3>
                <button
                    onClick={()=>{setShowing(null);}} 
                    className="text-2xl text-pj-secondary absolute top-0 right-0 p-5 hover:text-pj-primary hover:-scale-105"
                >
                ...
                <div className="grid place-items-center grid-flow-col grid-cols-4 py-10">
                    ...
                    <img className="col-span-2 px-6 border-l-2 border-pj-secondary" src={emebetPage} alt="" />
                </div>
            </div>
        </div>
    )
...
const Lce = ({showing, setShowing})=>{
    ...
    return (
        <div className={`${showing != null && 'block' || 'hidden'} w-full h-[80%] bg-pj-dark bottom-0 absolute z-30 px-10 transition ease-in duration-500`}>
            <div className="relative">
                <h3 className="text-4xl font-bold text-pj-primary py-5">The Lutheran Church of Ethiopia</h3>
                <button
                    onClick={()=>{setShowing(null);}} 
                    className="text-2xl text-pj-secondary absolute top-0 right-0 p-5 hover:text-pj-primary hover:-scale-105"
                >
