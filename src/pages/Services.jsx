    ...
    <div className="h-full relative">
        ...
        <div className={`${showing == null && 'flex' || 'hidden'} justify-center gap-40 w-full absolute top-1/2 transform -translate-y-1/2`}>
            <div
                ...
                className='relative w-44 cursor-pointer hover:scale-105 transition ease-in-out duration-200'
            >
                <img className="w-44" src={hexagon2} alt="" />
                <div className="absolute flex flex-col items-center justify-center w-44 top-1/2 transform -translate-y-1/2">
                    <img className="w-14" src={branding} alt="" />
                    <p className='text-2xl text-pj-white -mb-3 mt-3'>Branding</p>
                </div>
            </div>
            ...
            >
                <img className="w-44" src={hexagon2} alt="" />
                <div className="absolute flex flex-col items-center justify-center w-44 top-1/2 transform -translate-y-1/2">
                    <img className="w-14" src={website} alt="" />
                    <p className='text-2xl text-pj-white -mb-3 mt-3'>Website</p>
                </div>
            </div>
            ...
            >
                <img className="w-44" src={hexagon2} alt="" />
                <div className="absolute flex flex-col items-center justify-center w-44 top-1/2 transform -translate-y-1/2">
                    <img className="w-14" src={promotion} alt="" />
                    <p className='text-2xl text-pj-white -mb-3 mt-3'>Promotion</p>
                </div>
            </div>
        </div>
            ...
            <div className="relative">
                ...
                <div className="grid place-items-center grid-flow-col grid-cols-4 py-10">
                    <div className="col-span-2 text-pj-white px-6">
                        <h4 className="text-3xl text-pj-secondary font-semibold py-5">It's Important</h4>
                        <p className="">
                    ...
                    <img className="col-span-2 px-6 border-l-2 border-pj-secondary" src={brandingPic} alt="" />
                </div>
            </div>
        </div>
    )
    ...
    return (
        <div className={`${showing != null && 'block' || 'hidden'} w-full h-[80%] bg-pj-dark bottom-0 absolute z-30 px-10 transition ease-in duration-500`}>
            <div className="relative">
                ...
                <div className="w-full h-1 bg-pj-secondary"></div>
                <div className="grid place-items-center grid-flow-col grid-cols-4 py-10">
                    <img className="col-span-2 px-6 border-r-2 border-pj-secondary" src={websitePic} alt="" />
                    <div className="col-span-2 text-pj-white px-6">
                        <h4 className="text-3xl text-pj-secondary font-semibold py-5">You need one</h4>
                        <p className="">
    ...
    return (
        <div className={`${showing != null && 'block' || 'hidden'} w-full h-[80%] bg-pj-dark bottom-0 absolute z-30 px-10 transition ease-in duration-500`}>
            <div className="relative">
                ...
                <div className="grid place-items-center grid-flow-col grid-cols-4 py-10">
                    <div className="col-span-2 text-pj-white px-6">
                        <h4 className="text-3xl text-pj-secondary font-semibold py-5">How We Do It</h4>
                        <p className="">
                        ...
                        For example, do you want to introduce a new product, increase sales, boost brand awareness, or improve 
                        customer loyalty? Choose your promotion strategies. Based on your audience and objectives, select the 
                        best methods to promote your product or service. 
                    ...
                    <img className="col-span-2 px-6 border-l-2 border-pj-secondary" src={promotionPic} alt="" />
                </div>
            </div>
        </div>
    )
