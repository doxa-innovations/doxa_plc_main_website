...
export const Team = ()=>{
    ...
    <div className="h-full relative z-10">
       ...
       <svg 
        ...
        <div className={`${showing == null && 'flex' || 'hidden'} flex-col md:flex-row justify-center gap-2 md:gap-32 w-full absolute top-1/2 transform -translate-y-1/2`}>
            <div
            ...
            >
                <img className="w-24 md:w-44 relative z-30" src={EphremBW} alt="" />
