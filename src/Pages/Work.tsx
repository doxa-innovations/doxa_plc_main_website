...
export const Work = ():ReactElement =>{
		...
		return (
				<Layout title={'Team'} description={`Previous Projects`} backLink={'/'} lgLogoShow={false}>
...
const WorkProfile = ({key = null, filled = false, setShowing, data}: WorkProfileType): ReactElement => {
		...
		return (
				...
				>
						...
						>
								<img className={`w-2/6 z-20`} src={`/images/` + data.image} alt=""/>
