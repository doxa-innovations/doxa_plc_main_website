	...
	return (
		...
		>
			<div className={`h-full flex flex-col mt-5 md:mt-10 gap-5 z-50 relative`}>
				<strong
					className='text-2xl sm:text-4xl md:text-5xl text-pj-white text-center leading-[140%] md:leading-[120%]'>
					Doxa <strong
				...
				<div className='flex flex-col items-center md:mt-0 relative z-50'>
					<div className='grid grid-flow-col col-span-2 w-fit -mb-5 md:-mb-4 gap-2'>
						<Link href={'/services'}
							...
							<img className="w-24 md:w-28 z-20" src={"https://cdn.doxaplc.com/doxa-public/SVGs/hexagon.svg"} alt=""/>
					...
					<div className='grid grid-flow-col col-span-3 gap-2'>
						...
						<Link href={''}
							...
							<img
								...
								src={"https://cdn.doxaplc.com/doxa-public/logo.png"} alt=""/>
