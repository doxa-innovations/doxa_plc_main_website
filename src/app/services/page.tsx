	...
	return (
		...
		>
			...
			<div className="h-full relative overflow-y-scroll scrollbar">
				<div className={`mt-10 lg:mt-24 flex flex-wrap justify-center lg:px-80`}>
								...
								<svg className={`w-28 md:w-36 z-20 fill-pj-accent`} viewBox="0 0 177 195"
									...
									<g filter="url(#filter0_d_2001_7)">
										<path
											...
											stroke="#b277d3" strokeWidth="5" shapeRendering="crispEdges"/>
									</g>
								</svg>
					...
					<div className='flex flex-col justify-center items-center md:mt-0 relative z-50 w-[21rem] md:w-[25rem] '>
						<Link
							className={`relative z-50 w-28 md:w-36 cursor-pointer ${showing !== 'prices' ? 'hover:scale-90' : 'hover:scale-105'} transition ease-in-out duration-500`}
							href={"/prices"}
						>
							<svg className={`w-28 md:w-36 z-20 fill-pj-accent`} viewBox="0 0 177 195"
								 xmlns="http://www.w3.org/2000/svg">
							...
							<p className='absolute z-30 flex justify-center w-full px-3 top-1/2 transform -translate-y-1/2 text-sm md:text-base text-pj-white text-center'
							>
								Prices
							</p>
						</Link>
